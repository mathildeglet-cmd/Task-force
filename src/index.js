...
function createNewTask() {
	...
	newElement.choiceStatus =
		choiceStatus.options[choiceStatus.selectedIndex].textContent;
	newElement.choiceCategory =
		choiceCategory.options[choiceCategory.selectedIndex].textContent;
